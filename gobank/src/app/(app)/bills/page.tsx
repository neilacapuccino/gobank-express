...
export default function BillsPage() {
   ...
   */
  const currentBillers = selectedCategory
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[440px] flex-col px-5 pb-28">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="bg-surface-raised text-ink placeholder:text-ink-soft/50 h-12 w-full rounded-xl border border-transparent px-3.5 text-[13px] outline-none transition-all focus:border-[#00b98b]/40 focus:ring-2 focus:ring-[#00b98b]/10"
              />
            ...
            <div>
              ...
              <div className="relative">
                <span className="text-ink-soft pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[13px]">
                  ₱
                </span>
                ...
                <input
                  ...
                  className="bg-surface-raised text-ink placeholder:text-ink-soft/50 h-12 w-full rounded-xl border border-transparent pl-8 pr-3.5 text-[13px] outline-none transition-all focus:border-[#00b98b]/40 focus:ring-2 focus:ring-[#00b98b]/10"
                />
              </div>
        ...
        <section className="bg-surface-raised mt-6 rounded-2xl p-4">
          ...
          <div className="mt-2.5 flex items-center justify-between">
            ...
            <span className="text-[#00a77d] text-[11px] font-medium">
              ₱0.00
            </span>
          </div>
